...
const routes: Routes = [
    ...
    { path: 'index.php/fleet/:fname', component: FleetComponent, canActivate: [AuthGuardService] },
    { path: 'index.php/vehicle/:vname', component: VehicleComponent, canActivate: [AuthGuardService] },
    { path: 'index.php/vehicledaily/:vname', component: AnalysisDailyComponent, canActivate: [AuthGuardService] },
    { path: 'index.php/vehiclealert/:vname', component: AnalysisAlertComponent, canActivate: [AuthGuardService] },
    { path: 'index.php/dailyreport/:fname', component: DailyReportComponent, canActivate: [AuthGuardService] },
    { path: 'index.php/monthlyreport/:fname', component: MonthlyReportComponent, canActivate: [AuthGuardService] },
    { path: 'index.php/dailylog/:fname', component: DailyLogComponent, canActivate: [AuthGuardService] },
