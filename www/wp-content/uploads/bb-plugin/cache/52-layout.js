var wpAjaxUrl = 'http://localhost:8080/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://localhost:8080/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://localhost:8080/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'http://localhost:8080/wp-admin/admin-ajax.php'
	}
};(function($){
